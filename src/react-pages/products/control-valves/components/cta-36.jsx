      ...
      <div className="container">
        <div className="grid auto-cols-fr grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 lg:gap-x-16">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p>
              Discover our range of control valves designed for optimal flow
              regulation in industrial applications.
            </p>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p>
              Experience unmatched precision and efficiency with our Larner
              Johnson valves for diverse industrial systems.
            </p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
